...
exports.commands = {
	uno: function (target, room, user) {
		...
		case "new":
			...
			if (pot && room.id !== 'game') return this.errorReply('You cannot start a game with bets in rooms besides Uno');
			if (room.id !== 'game') return this.errorReply('You can only start a uno game in the games room');
